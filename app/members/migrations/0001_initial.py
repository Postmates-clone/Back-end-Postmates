# Generated by Django 3.0.8 on 2020-07-14 04:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, help_text='유저 고유 값 uid', unique=True)),
                ('email', models.EmailField(help_text='이메일', max_length=254, primary_key=True, serialize=False)),
                ('username', models.CharField(help_text='닉네임', max_length=30, unique=True)),
                ('phone', models.CharField(blank=True, help_text='핸드폰 번호', max_length=16)),
